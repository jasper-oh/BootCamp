...
request.setCharacterEncoding("utf-8");
	...
	String whereStatement = " select name, tel , address from purchaseinfo where id = ?";
	try{
...
<form action="purchaserSelect_04.jsp" method="post"></form>
	userId : <input type="hidden" name="userid" size =10 value = "<%=userid %>" readonly="readonly"><br>
	name : <input type="hidden" name="name" size =10 value = "<%=name %>" ><br>
	phone : <input type="hidden" name="tel" size =40 value = "<%=tel %>"><br>
	address : <input type="hidden" name="address" size =50 value = "<%=address %>" ><br>
