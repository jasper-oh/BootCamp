...
import com.aoslec.day46lecture.databinding.ActivityOptionMenuBinding;
...
public class OptionMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_option_menu);
