...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    private String[] detailes = {"월요일 기상정보","화요일 기상정보","수요일 기상정보","목요일 기상정보","금요일 기상정보","토요일 기상정보","일요일 기상정보"};
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Snackbar.make(v,detailes[position],Snackbar.LENGTH_LONG).setAction("",null).show();
                }
            });
    ...
    public void onBindViewHolder(@NonNull RecyclerAdapter.ViewHolder holder, int position) {
        ...
        holder.itemDetail.setText(detailes[position]);
